# Multi-architecture manifest for Python 3.12.13 slim (verified 2026-07-24).
# Dependabot proposes reviewed digest updates; never silently float on the tag alone.

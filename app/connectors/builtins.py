...
def built_in_connectors() -> list:
    return [
        ...
        AdapterBackedConnector(
            manifest=ConnectorManifest(
                id="sab_usenet",
                display_name="SABnzbd Completed Folder",
                kind=ConnectorKind.SOURCE,
                api_version=MANIFEST_API_VERSION,
                adapter_class="adapters.completed_folder:SabUsenetCompletedAdapter",
                default_enabled=False,
                required=False,
                install_profile=None,
                docker_service="sabnzbd",
                required_env=("SAB_USENET_ENABLED", "SAB_USENET_DOWNLOAD_ROOT"),
                optional_env=(
                    "SAB_USENET_MAX_FILES",
                    "SAB_USENET_MAX_BYTES",
                    "SAB_USENET_SETTLE_SECONDS",
                ),
                capabilities=(
                    "completed_folder_ingest",
                    "copy_source_files",
                    "manual_enqueue",
                    "usenet_category_ingest",
                ),
                docs_url="operations/CONFIGURATION.md#44-sabnzbd-completed-folder",
                min_supported_version=None,
            ),
            adapter_name="sab_usenet",
        ),
        AdapterBackedConnector(
            manifest=ConnectorManifest(
                id="qbittorrent_torrent",
                display_name="qBittorrent Completed Folder",
                kind=ConnectorKind.SOURCE,
                api_version=MANIFEST_API_VERSION,
                adapter_class="adapters.completed_folder:QBittorrentCompletedAdapter",
                default_enabled=False,
                required=False,
                install_profile=None,
                docker_service="qbittorrent",
                required_env=(
                    "QBITTORRENT_TORRENT_ENABLED",
                    "QBITTORRENT_TORRENT_DOWNLOAD_ROOT",
                ),
                optional_env=(
                    "QBITTORRENT_TORRENT_MAX_FILES",
                    "QBITTORRENT_TORRENT_MAX_BYTES",
                    "QBITTORRENT_TORRENT_SETTLE_SECONDS",
                ),
                capabilities=(
                    "completed_folder_ingest",
                    "copy_source_files",
                    "manual_enqueue",
                    "torrent_category_ingest",
                ),
                docs_url="operations/CONFIGURATION.md#45-qbittorrent-completed-folder",
                min_supported_version=None,
            ),
            adapter_name="qbittorrent_torrent",
        ),
        BinaryConnector(
            manifest=ConnectorManifest(
                id="ffprobe",
